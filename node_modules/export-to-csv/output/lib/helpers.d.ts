...
export declare const buildRow: (config: WithDefaults<ConfigOptions>) => (row: CsvRow, data: string) => CsvRow;
...
export declare const formatData: (config: ConfigOptions, data: any) => string;
